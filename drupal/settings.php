...
if (!empty(getenv("GOVIBOX_SITENAME"))) {
    $databases = array (
      'default' => 
      array (
        'default' => 
        array (
          'database' => getenv('GOVIBOX_DB_NAME'),
          'username' => getenv('GOVIBOX_DB_USER'),
          'password' => getenv('GOVIBOX_DB_PASSWORD'),
          'host' => trim(getenv('GOVIBOX_DB_HOST')),
          'port' => '3306',
          'driver' => 'mysql',
          'prefix' => '',
    	),
 ...
 *
 */
$drupal_hash_salt = 'FGIt-MUlpSrKpycRSeZKQQZR4d6CGWpy5Rta9YjLdGg';
